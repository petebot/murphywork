...
function instance($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$" && key !== "slot")
      console.warn(`<DefaultMark> was created with unknown prop '${key}'`);
  });
  $$self.$$set = ($$props2) => {
    if ("portableText" in $$props2)
      $$invalidate(1, portableText = $$props2.portableText);
    if ("$$scope" in $$props2)
  ...
  $$self.$inject_state = ($$props2) => {
    if ("portableText" in $$props2)
      $$invalidate(1, portableText = $$props2.portableText);
    if ("markType" in $$props2)
      $$invalidate(0, markType = $$props2.markType);
  };
...
function instance2($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$" && key !== "slot")
      console.warn(`<DefaultLink> was created with unknown prop '${key}'`);
  });
  $$self.$$set = ($$props2) => {
    if ("portableText" in $$props2)
      $$invalidate(1, portableText = $$props2.portableText);
...
function create_fragment3(ctx) {
  ...
  function select_block_type(ctx2, dirty) {
    ...
    1)
      show_if = null;
    if (show_if == null)
      show_if = !!["h1", "h2", "h3", "h4", "h5", "h6", "blockquote"].includes(
        /*style*/
        ctx2[0]
      );
    if (show_if)
...
function instance3($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$" && key !== "slot")
      console.warn(`<DefaultBlock> was created with unknown prop '${key}'`);
  });
  $$self.$$set = ($$props2) => {
    if ("portableText" in $$props2)
      $$invalidate(1, portableText = $$props2.portableText);
...
function instance4($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$" && key !== "slot")
      console.warn(`<DefaultList> was created with unknown prop '${key}'`);
  });
  $$self.$$set = ($$props2) => {
    if ("portableText" in $$props2)
      $$invalidate(1, portableText = $$props2.portableText);
  ...
  $$self.$inject_state = ($$props2) => {
    ...
    if ("value" in $$props2)
      $$invalidate(2, value = $$props2.value);
    if ("listItem" in $$props2)
      $$invalidate(0, listItem = $$props2.listItem);
  };
  if ($$props && "$$inject" in $$props) {
    $$self.$inject_state($$props.$$inject);
  }
...
function instance5($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$" && key !== "slot")
      console.warn(`<DefaultListItem> was created with unknown prop '${key}'`);
  });
  $$self.$$set = ($$props2) => {
    if ("$$scope" in $$props2)
...
function instance6($$self, $$props) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$" && key !== "slot")
      console.warn(`<DefaultHardBreak> was created with unknown prop '${key}'`);
  });
  return [];
}
...
function instance7($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$" && key !== "slot")
      console.warn(`<UnknownType> was created with unknown prop '${key}'`);
  });
  $$self.$$set = ($$props2) => {
    if ("$$scope" in $$props2)
      $$invalidate(0, $$scope = $$props2.$$scope);
  ...
  const block = {
    ...
    p: function update(ctx2, [dirty]) {
      ...
      ctx2[1].unknownBlockStyle)) {
        ...
        if (dirty & /*blockProps*/
        4)
          switch_instance_changes.portableText = /*blockProps*/
          ctx2[2];
        if (dirty & /*$$scope*/
        256) {
...
function instance8($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$" && key !== "slot")
      console.warn(`<RenderBlock> was created with unknown prop '${key}'`);
  });
  $$self.$$set = ($$props2) => {
    if ("global" in $$props2)
      $$invalidate(3, global = $$props2.global);
    if ("node" in $$props2)
      $$invalidate(4, node = $$props2.node);
    if ("indexInParent" in $$props2)
      $$invalidate(5, indexInParent = $$props2.indexInParent);
    if ("$$scope" in $$props2)
  ...
  $$self.$inject_state = ($$props2) => {
    ...
    if ("indexInParent" in $$props2)
      $$invalidate(5, indexInParent = $$props2.indexInParent);
    if ("blockProps" in $$props2)
      $$invalidate(2, blockProps = $$props2.blockProps);
    if ("style" in $$props2)
      $$invalidate(6, style = $$props2.style);
    if ("blockComponent" in $$props2)
      $$invalidate(0, blockComponent = $$props2.blockComponent);
  ...
  const block = {
    ...
    p: function update(ctx2, [dirty]) {
      ...
      ctx2[1].unknownType)) {
        ...
        4)
          switch_instance_changes.portableText = /*componentProps*/
          ctx2[2];
        switch_instance.$set(switch_instance_changes);
      }
    },
...
function instance9($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$" && key !== "slot")
      console.warn(`<RenderCustomBlock> was created with unknown prop '${key}'`);
  });
  $$self.$$set = ($$props2) => {
    if ("global" in $$props2)
      $$invalidate(3, global = $$props2.global);
    if ("node" in $$props2)
      $$invalidate(4, node = $$props2.node);
    if ("parentBlock" in $$props2)
      $$invalidate(5, parentBlock = $$props2.parentBlock);
    if ("indexInParent" in $$props2)
      $$invalidate(6, indexInParent = $$props2.indexInParent);
    if ("isInline" in $$props2)
      $$invalidate(7, isInline = $$props2.isInline);
  };
  $$self.$capture_state = () => ({
    global,
    node,
  ...
  $$self.$inject_state = ($$props2) => {
    ...
    if ("isInline" in $$props2)
      $$invalidate(7, isInline = $$props2.isInline);
    if ("componentProps" in $$props2)
      $$invalidate(2, componentProps = $$props2.componentProps);
    if ("_type" in $$props2)
      $$invalidate(8, _type = $$props2._type);
    if ("customComponent" in $$props2)
      $$invalidate(0, customComponent = $$props2.customComponent);
    if ("components" in $$props2)
      $$invalidate(1, components = $$props2.components);
  };
  if ($$props && "$$inject" in $$props) {
  ...
  const block = {
    ...
    p: function update(ctx2, [dirty]) {
      ...
      ctx2[1].unknownList)) {
        ...
        if (dirty & /*listProps*/
        4)
          switch_instance_changes.portableText = /*listProps*/
          ctx2[2];
        if (dirty & /*$$scope*/
        512) {
          switch_instance_changes.$$scope = { dirty, ctx: ctx2 };
...
function instance10($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$" && key !== "slot")
      console.warn(`<RenderList> was created with unknown prop '${key}'`);
  });
  $$self.$$set = ($$props2) => {
    if ("global" in $$props2)
      $$invalidate(3, global = $$props2.global);
    if ("indexInParent" in $$props2)
      $$invalidate(4, indexInParent = $$props2.indexInParent);
    if ("node" in $$props2)
  ...
  $$self.$inject_state = ($$props2) => {
    ...
    if ("listProps" in $$props2)
      $$invalidate(2, listProps = $$props2.listProps);
    if ("listItem" in $$props2)
      $$invalidate(6, listItem = $$props2.listItem);
    if ("listComponent" in $$props2)
      $$invalidate(0, listComponent = $$props2.listComponent);
  ...
  const block = {
    ...
    p: function update(ctx2, dirty) {
      ...
      ctx2[4])) {
        ...
        9)
          switch_instance_changes.portableText = {
            // Different props for the block that will hold this list
            .../*listItemProps*/
            ctx2[3],
            value: {
  ...
  const block = {
    ...
    p: function update(ctx2, [dirty]) {
      ...
      ctx2[1].unknownListItem)) {
        ...
        8)
          switch_instance_changes.portableText = /*listItemProps*/
          ctx2[3];
...
function instance11($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$" && key !== "slot")
      console.warn(`<RenderListItem> was created with unknown prop '${key}'`);
  });
  $$self.$$set = ($$props2) => {
    if ("global" in $$props2)
      $$invalidate(5, global = $$props2.global);
    if ("indexInParent" in $$props2)
      $$invalidate(6, indexInParent = $$props2.indexInParent);
    if ("node" in $$props2)
  ...
  $$self.$inject_state = ($$props2) => {
    ...
    if ("node" in $$props2)
      $$invalidate(0, node = $$props2.node);
    if ("listItemProps" in $$props2)
      $$invalidate(3, listItemProps = $$props2.listItemProps);
    if ("style" in $$props2)
      $$invalidate(7, style = $$props2.style);
    if ("components" in $$props2)
      $$invalidate(1, components = $$props2.components);
    if ("styleComponent" in $$props2)
      $$invalidate(4, styleComponent = $$props2.styleComponent);
    if ("listItemComponent" in $$props2)
      $$invalidate(2, listItemComponent = $$props2.listItemComponent);
  };
  if ($$props && "$$inject" in $$props) {
    $$self.$inject_state($$props.$$inject);
  }
  ...
  const block = {
    ...
    p: function update(ctx2, [dirty]) {
      ...
      ctx2[1].unknownMark)) {
        ...
        if (dirty & /*markProps*/
        4)
          switch_instance_changes.portableText = /*markProps*/
          ctx2[2];
        if (dirty & /*$$scope*/
        256) {
          switch_instance_changes.$$scope = { dirty, ctx: ctx2 };
...
function instance12($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$" && key !== "slot")
      console.warn(`<RenderSpan> was created with unknown prop '${key}'`);
  });
  $$self.$$set = ($$props2) => {
    if ("global" in $$props2)
      $$invalidate(3, global = $$props2.global);
  ...
  $$self.$inject_state = ($$props2) => {
    ...
    if ("parentBlock" in $$props2)
      $$invalidate(5, parentBlock = $$props2.parentBlock);
    if ("markType" in $$props2)
      $$invalidate(6, markType = $$props2.markType);
    if ("markProps" in $$props2)
      $$invalidate(2, markProps = $$props2.markProps);
    if ("markComponent" in $$props2)
      $$invalidate(0, markComponent = $$props2.markComponent);
    if ("components" in $$props2)
      $$invalidate(1, components = $$props2.components);
  };
  if ($$props && "$$inject" in $$props) {
...
function instance13($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$" && key !== "slot")
      console.warn(`<RenderText> was created with unknown prop '${key}'`);
  });
  $$self.$$set = ($$props2) => {
    if ("global" in $$props2)
...
function create_if_block_5(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, dirty) {
      ...
      if (dirty & /*node*/
      16)
        rendercustomblock_changes.node = /*node*/
        ctx2[4];
      if (dirty & /*parentBlock*/
      4)
        rendercustomblock_changes.parentBlock = /*parentBlock*/
        ctx2[2];
      if (dirty & /*indexInParent*/
      8)
        rendercustomblock_changes.indexInParent = /*indexInParent*/
        ctx2[3];
      if (dirty & /*isInline*/
      2)
        rendercustomblock_changes.isInline = /*isInline*/
        ctx2[1];
      if (dirty & /*global*/
      1)
        rendercustomblock_changes.global = /*global*/
        ctx2[0];
...
function create_if_block_42(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, dirty) {
      ...
      if (dirty & /*node*/
      16)
        rendertext_changes.node = /*node*/
        ctx2[4];
      if (dirty & /*global*/
      1)
        rendertext_changes.global = /*global*/
        ctx2[0];
...
function create_if_block_32(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, dirty) {
      ...
      if (dirty & /*node*/
      16)
        renderblock_changes.node = /*node*/
        ctx2[4];
      if (dirty & /*indexInParent*/
      8)
        renderblock_changes.indexInParent = /*indexInParent*/
        ctx2[3];
      if (dirty & /*global*/
      1)
        renderblock_changes.global = /*global*/
        ctx2[0];
...
function create_if_block_22(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, dirty) {
      ...
      if (dirty & /*node*/
      16)
        renderspan_changes.node = /*node*/
        ctx2[4];
      if (dirty & /*parentBlock*/
      4)
        renderspan_changes.parentBlock = /*parentBlock*/
        ctx2[2];
      if (dirty & /*global*/
      1)
        renderspan_changes.global = /*global*/
        ctx2[0];
...
function create_if_block_14(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, dirty) {
      ...
      if (dirty & /*node*/
      16)
        renderlistitem_changes.node = /*node*/
        ctx2[4];
      if (dirty & /*indexInParent*/
      8)
        renderlistitem_changes.indexInParent = /*indexInParent*/
        ctx2[3];
      if (dirty & /*global*/
      1)
        renderlistitem_changes.global = /*global*/
        ctx2[0];
      if (dirty & /*$$scope, node, global*/
      4113) {
...
function create_if_block7(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, dirty) {
      ...
      if (dirty & /*node*/
      16)
        renderlist_changes.node = /*node*/
        ctx2[4];
      if (dirty & /*indexInParent*/
      8)
        renderlist_changes.indexInParent = /*indexInParent*/
        ctx2[3];
      if (dirty & /*global*/
      1)
        renderlist_changes.global = /*global*/
        ctx2[0];
      if (dirty & /*$$scope, node, global*/
      4113) {
...
function create_each_block_3(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, dirty) {
      ...
      if (dirty & /*global*/
      1)
        rendernode_changes.global = /*global*/
        ctx2[0];
...
function create_fragment14(ctx) {
  ...
  function select_block_type(ctx2, dirty) {
    ...
    16)
      show_if_4 = null;
    if (show_if == null)
      show_if = !!isPortableTextToolkitList(
        /*node*/
        ctx2[4]
      );
    if (show_if)
      return 0;
    if (show_if_1 == null)
      show_if_1 = !!isPortableTextListItemBlock(
        /*node*/
        ctx2[4]
      );
    if (show_if_1)
      return 1;
    if (show_if_2 == null)
      show_if_2 = !!isPortableTextToolkitSpan(
        /*node*/
        ctx2[4]
      );
    if (show_if_2)
    ...
    if (show_if_3)
      return 3;
    if (show_if_4 == null)
      show_if_4 = !!isPortableTextToolkitTextNode(
        /*node*/
        ctx2[4]
      );
    if (show_if_4)
...
function instance14($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$" && key !== "slot")
      console.warn(`<RenderNode> was created with unknown prop '${key}'`);
  });
  $$self.$$set = ($$props2) => {
    if ("global" in $$props2)
      $$invalidate(0, global = $$props2.global);
  ...
  $$self.$inject_state = ($$props2) => {
    ...
    if ("options" in $$props2)
      $$invalidate(5, options = $$props2.options);
    if ("isInline" in $$props2)
      $$invalidate(1, isInline = $$props2.isInline);
    if ("parentBlock" in $$props2)
      $$invalidate(2, parentBlock = $$props2.parentBlock);
    if ("indexInParent" in $$props2)
      $$invalidate(3, indexInParent = $$props2.indexInParent);
    if ("node" in $$props2)
      $$invalidate(4, node = $$props2.node);
  };
  if ($$props && "$$inject" in $$props) {
...
function instance15($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$" && key !== "slot")
      console.warn(`<PortableText> was created with unknown prop '${key}'`);
  });
  $$self.$$set = ($$props2) => {
    if ("value" in $$props2)
      $$invalidate(0, value = $$props2.value);
    if ("components" in $$props2)
      $$invalidate(5, components = $$props2.components);
    if ("context" in $$props2)
      $$invalidate(1, context = $$props2.context);
    if ("onMissingComponent" in $$props2)
      $$invalidate(6, onMissingComponent = $$props2.onMissingComponent);
  };
  $$self.$capture_state = () => ({
    LIST_NEST_MODE_HTML,
    nestLists,
  ...
  $$self.$inject_state = ($$props2) => {
    ...
    if ("onMissingComponent" in $$props2)
      $$invalidate(6, onMissingComponent = $$props2.onMissingComponent);
    if ("missingComponentHandler" in $$props2)
      $$invalidate(2, missingComponentHandler = $$props2.missingComponentHandler);
    if ("keyedBlocks" in $$props2)
      $$invalidate(7, keyedBlocks = $$props2.keyedBlocks);
    if ("blocks" in $$props2)
      $$invalidate(3, blocks = $$props2.blocks);
    if ("mergedComponents" in $$props2)
      $$invalidate(4, mergedComponents = $$props2.mergedComponents);
  };
  if ($$props && "$$inject" in $$props) {
    $$self.$inject_state($$props.$$inject);
  }
