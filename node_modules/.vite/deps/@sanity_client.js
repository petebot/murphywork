...
function _fetch(client, httpRequest, _stega, query, _params = {}, options = {}) {
  ...
  return stega.enabled ? $request.pipe(
    combineLatestWith(
      from(
        import("./stegaEncodeSourceMap-TBCEIIBT.js").then(function(n4) {
...
function _listen(query, params, opts = {}) {
  ...
  return (token || withCredentials) && (esOptions.withCredentials = true), token && (esOptions.headers = {
    ...
    async function getEventSource() {
      const { default: EventSource2 } = await import("./browser-LD7ABIOM.js");
      if (unsubscribed)
        return;
...
var LiveClient = class {
  ...
  events({
    ...
    return includeDrafts && token && (esOptions.headers = {
      ...
      async function getEventSource() {
        const EventSourceImplementation = typeof EventSource > "u" || esOptions.headers ? (await import("./browser-LD7ABIOM.js")).default : EventSource;
        if (unsubscribed)
          return;
